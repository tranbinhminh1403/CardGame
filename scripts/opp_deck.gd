...
const CARD_SCENE_PATH = "res://scenes/opp_card.tscn"
const STARTING_HAND_SIZE = 5

var opp_deck = ["Golshi", "Tachyon", "Tachyon", "Stego", "Teio", "Tachyon", "Tachyon", "Tachyon"]
var card_db_ref
...
func _ready() -> void:
	opp_deck.shuffle()
	$RichTextLabel.text = str(opp_deck.size())
